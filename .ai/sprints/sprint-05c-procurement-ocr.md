...
- Migración correctiva `00071`: las RPCs internas service-role se protegen por `EXECUTE grant` y no por GUC legacy `request.jwt.claim.role`, porque el smoke real mostró que esa GUC puede venir vacía en llamadas PostgREST con service key.
...
- Types Supabase: `src/types/database.ts` debe regenerarse tras aplicar 00068-00071 por WALL-E.
