  ...
  public: {
    Tables: {
      ...
      v3_goods_receipt_lines: {
        Row: {
          ...
          quality_status: Database["public"]["Enums"]["v3_gr_quality_status"]
          quantity_received: number
          rejection_reason: string | null
          unit_id: string | null
          unit_price: number
        ...
        Relationships: [
          {
            foreignKeyName: "v3_goods_receipt_lines_goods_receipt_id_fkey"
          ...
          {
            foreignKeyName: "v3_goods_receipt_lines_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "v3_hotels"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_goods_receipt_lines_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "v3_products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_goods_receipt_lines_purchase_order_line_id_fkey"
            columns: ["purchase_order_line_id"]
            isOneToOne: false
            referencedRelation: "v3_purchase_order_lines"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "v3_goods_receipt_lines_unit_id_fkey"
            columns: ["unit_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "v3_gr_lines_po_line_hotel_fkey"
            columns: ["hotel_id", "purchase_order_line_id"]
            isOneToOne: false
            referencedRelation: "v3_purchase_order_lines"
            referencedColumns: ["hotel_id", "id"]
          },
          {
            foreignKeyName: "v3_gr_lines_product_hotel_fkey"
          ...
          {
            foreignKeyName: "v3_gr_lines_receipt_hotel_fkey"
          ...
          {
            foreignKeyName: "v3_gr_lines_unit_hotel_fkey"
      ...
      v3_goods_receipts: {
        ...
        Relationships: [
          {
            foreignKeyName: "v3_goods_receipts_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "v3_hotels"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_goods_receipts_purchase_order_id_fkey"
            columns: ["purchase_order_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "v3_goods_receipts_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "v3_gr_purchase_order_hotel_fkey"
          ...
          {
            foreignKeyName: "v3_gr_supplier_hotel_fkey"
      ...
      v3_price_change_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "v3_price_change_log_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "v3_hotels"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_price_change_log_po_line_hotel_fkey"
            columns: ["hotel_id", "purchase_order_line_id"]
            isOneToOne: false
            referencedRelation: "v3_purchase_order_lines"
            referencedColumns: ["hotel_id", "id"]
          ...
          {
            foreignKeyName: "v3_price_change_log_product_hotel_fkey"
            columns: ["hotel_id", "product_id"]
            isOneToOne: false
            referencedRelation: "v3_products"
            referencedColumns: ["hotel_id", "id"]
          ...
          {
            foreignKeyName: "v3_price_change_log_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "v3_products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_price_change_log_purchase_order_line_id_fkey"
            columns: ["purchase_order_line_id"]
            isOneToOne: false
            referencedRelation: "v3_purchase_order_lines"
            referencedColumns: ["id"]
      ...
      v3_purchase_order_lines: {
        ...
        Relationships: [
          {
            foreignKeyName: "v3_po_lines_order_hotel_fkey"
            columns: ["hotel_id", "purchase_order_id"]
            isOneToOne: false
            referencedRelation: "v3_purchase_orders"
            referencedColumns: ["hotel_id", "id"]
          ...
          {
            foreignKeyName: "v3_po_lines_pr_line_hotel_fkey"
            columns: ["hotel_id", "purchase_request_line_id"]
            isOneToOne: false
            referencedRelation: "v3_purchase_request_lines"
            referencedColumns: ["hotel_id", "id"]
          },
          {
            foreignKeyName: "v3_po_lines_product_hotel_fkey"
            columns: ["hotel_id", "product_id"]
            isOneToOne: false
            referencedRelation: "v3_products"
            referencedColumns: ["hotel_id", "id"]
          ...
          {
            foreignKeyName: "v3_po_lines_unit_hotel_fkey"
            columns: ["hotel_id", "unit_id"]
            isOneToOne: false
            referencedRelation: "v3_units_of_measure"
            referencedColumns: ["hotel_id", "id"]
          ...
          {
            foreignKeyName: "v3_purchase_order_lines_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "v3_events"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_purchase_order_lines_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "v3_hotels"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_purchase_order_lines_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "v3_products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_purchase_order_lines_purchase_order_id_fkey"
            columns: ["purchase_order_id"]
            isOneToOne: false
            referencedRelation: "v3_purchase_orders"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_purchase_order_lines_purchase_request_line_id_fkey"
            columns: ["purchase_request_line_id"]
            isOneToOne: false
            referencedRelation: "v3_purchase_request_lines"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "v3_purchase_order_lines_unit_id_fkey"
            columns: ["unit_id"]
            isOneToOne: false
            referencedRelation: "v3_units_of_measure"
            referencedColumns: ["id"]
      ...
      v3_purchase_orders: {
        Row: {
          ...
          sent_at: string | null
          status: Database["public"]["Enums"]["v3_po_status"]
          supplier_id: string
          updated_at: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "v3_purchase_orders_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "v3_hotels"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_purchase_orders_supplier_hotel_fkey"
            columns: ["hotel_id", "supplier_id"]
            isOneToOne: false
            referencedRelation: "v3_suppliers"
            referencedColumns: ["hotel_id", "id"]
          ...
          {
            foreignKeyName: "v3_purchase_orders_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "v3_suppliers"
            referencedColumns: ["id"]
      ...
      v3_purchase_request_lines: {
        ...
        Relationships: [
          {
            foreignKeyName: "v3_pr_lines_product_hotel_fkey"
            columns: ["hotel_id", "product_id"]
            isOneToOne: false
            referencedRelation: "v3_products"
            referencedColumns: ["hotel_id", "id"]
          ...
          {
            foreignKeyName: "v3_pr_lines_request_hotel_fkey"
            columns: ["hotel_id", "purchase_request_id"]
            isOneToOne: false
            referencedRelation: "v3_purchase_requests"
            referencedColumns: ["hotel_id", "id"]
          },
          {
            foreignKeyName: "v3_pr_lines_unit_hotel_fkey"
            columns: ["hotel_id", "unit_id"]
            isOneToOne: false
            referencedRelation: "v3_units_of_measure"
            referencedColumns: ["hotel_id", "id"]
          ...
          {
            foreignKeyName: "v3_purchase_request_lines_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "v3_events"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_purchase_request_lines_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "v3_hotels"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_purchase_request_lines_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "v3_products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_purchase_request_lines_purchase_request_id_fkey"
          ...
          {
            foreignKeyName: "v3_purchase_request_lines_unit_id_fkey"
            columns: ["unit_id"]
            isOneToOne: false
            referencedRelation: "v3_units_of_measure"
            referencedColumns: ["id"]
      ...
      v3_purchase_requests: {
        Row: {
          ...
          needed_date: string
          notes: string | null
          origin: Database["public"]["Enums"]["v3_pr_origin"]
          requested_by: string
          status: Database["public"]["Enums"]["v3_pr_status"]
          updated_at: string
        }
        Insert: {
          approved_at?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "v3_purchase_requests_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "v3_events"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "v3_purchase_requests_hotel_id_fkey"
            columns: ["hotel_id"]
            isOneToOne: false
            referencedRelation: "v3_hotels"
            referencedColumns: ["id"]
      ...
      v3_supplier_incidents: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "v3_supplier_incidents_po_fkey"
            columns: ["hotel_id", "purchase_order_id"]
            isOneToOne: false
            referencedRelation: "v3_purchase_orders"
            referencedColumns: ["hotel_id", "id"]
    ...
    Functions: {
      ...
      v3_create_purchase_request: {
        Args: {
          ...
          p_notes?: string
          p_origin: Database["public"]["Enums"]["v3_pr_origin"]
        }
        Returns: string
      }
      ...
      v3_generate_purchase_order: {
        Args: { p_hotel_id: string; p_pr_ids: string[] }
        Returns: Json
      }
      ...
      v3_generate_purchase_requests_for_event_internal: {
        Args: { p_event_id: string; p_hotel_id: string }
        Returns: Json
      }
      ...
      v3_transition_purchase_order: {
        Args: {
          p_hotel_id: string
          p_new_status: Database["public"]["Enums"]["v3_po_status"]
          p_order_id: string
          p_reason?: string
        }
        Returns: undefined
      ...
      v3_transition_purchase_request: {
        Args: {
          p_hotel_id: string
          p_new_status: Database["public"]["Enums"]["v3_pr_status"]
          p_reason?: string
          p_request_id: string
        }
        Returns: undefined
      ...
      v3_validate_po_transition: {
        Args: {
          p_from: Database["public"]["Enums"]["v3_po_status"]
          p_to: Database["public"]["Enums"]["v3_po_status"]
        }
        Returns: boolean
      }
      v3_validate_pr_transition: {
        Args: {
          p_from: Database["public"]["Enums"]["v3_pr_status"]
          p_to: Database["public"]["Enums"]["v3_pr_status"]
        }
        Returns: boolean
      }
    ...
    Enums: {
      ...
      v3_expiry_treatment:
        ...
        | "chilled"
        | "other"
      v3_gr_quality_status: "accepted" | "partial" | "rejected"
