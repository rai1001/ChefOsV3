      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <header>
          ...
          <p className="text-sm text-[color:var(--color-text-muted)] mt-2 max-w-3xl">
            ...
            <span className="font-data">Ingredientes</span>. Las recetas válidas se crean en
            estado <strong>borrador</strong>. Los ingredientes quedan con mapping a producto
            pendiente — los completarás cuando exista el catálogo de productos.
          </p>
        </header>
